!(function (e, t) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports.MiniValine = t())
    : (e.MiniValine = t());
})(window, function () {
  return (function (e) {
    function t(t) {
      for (var n, r, o = t[0], a = t[1], c = 0, s = []; c < o.length; c++)
        (r = o[c]),
          Object.prototype.hasOwnProperty.call(i, r) && i[r] && s.push(i[r][0]),
          (i[r] = 0);
    ...
    (r.e = function (e) {
      ...
      (r.p = "https://cdn.jsdelivr.net/npm/minivaline@2.7.5/dist/"),
      (r.oe = function (e) {
        throw (console.error(e), e);
      });
    var o = (window.webpackJsonpMiniValine =
        window.webpackJsonpMiniValine || []),
      a = o.push.bind(o);
    (o.push = t), (o = o.slice());
      ...
      var i = {
        on: function (e, t, n, r) {
          for (var o = 0, a = (e = e.split(" ")).length; o < a; o++)
            i.off(e[o], t, n, r),
              t.addEventListener
                ? t.addEventListener(e[o], n, r || !1)
                : t.attachEvent
                ? t.attachEvent("on".concat(e[o]), n)
                : (t["on".concat(e[o])] = n);
        },
    ...
    function (e, t, n) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.i18nUrl =
          "https://cdn.jsdelivr.net/gh/MiniValine/minivaline-i18n@latest/"),
      ...
      e.exports = function (e) {
        ...
        (n.onreadystatechange = function () {
          if (4 === n.readyState) {
            var t = n.status;
            200 <= t && t < 300
              ? e.success && e.success(n.responseText, n.responseXML)
              : e.fail && e.fail(t);
          }
        }),
          "GET" == e.type
            ? (n.open("GET", e.url + "?" + t, !0), n.send(null))
            : "POST" == e.type &&
              (n.open("POST", e.url, !0),
              n.setRequestHeader(
                "Content-Type",
    ...
    function (e, t, n) {
      ...
      e.exports = function (e, t) {
        Promise.all([n.e(12), n.e(14)])
          .then(n.t.bind(null, 52, 7))
          .then(function (n) {
            var i = n.XSS;
            (e.TEXT = i(e.TEXT)), t(e);
          });
      ...
      e.exports = function (e, t) {
        if (document.selection)
          ...
          var n = e.selectionStart,
            ...
            r = e.scrollTop;
          (e.value =
            e.value.substring(0, n) + t + e.value.substring(i, e.value.length)),
            e.focus(),
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        ...
        if (t) {
          t = JSON.parse(t);
          for (var n = ["nick", "link", "mail"], r = 0; r < n.length; r++) {
            var o = n[r];
            (e.el.querySelector(".v".concat(o)).value = t[o]), (e.C[o] = t[o]);
          }
          "" !== t.mail &&
            "DesertsP" === e.mode &&
            e.el
              .querySelector(".visitor_avatar")
              .setAttribute(
                "data-src",
                "".concat(
                  i.GBUrl + md5(t.mail.toLowerCase().trim()),
                  "?size=80&d=robohash"
                )
              );
        }
    ...
    function (e, t, n) {
      ...
      e.exports = function (e, t, n) {
        var r = e.C.comment.match(/!\(:(.*?\.\w+):\)/g);
        if (r)
          for (var o = 0; o < r.length; o++) {
            var a = r[o].match(/!\(:(.*?\.\w+):\)/)[1],
              c = e.emoticon[a],
              l = new RegExp("!\\(:" + a.replace(/\./, "\\.") + ":\\)", "g");
            e.C.comment = e.C.comment.replace(
              l,
              '<img src="'
                .concat(c, '" alt="')
                .concat(a, '" class="vemoticon-img">')
            );
          }
        (t.TEXT = e.C.comment), (0, i.default)(e, t, n);
      };
    },
    function (e, t, n) {
      "use strict";
    ...
    function (e, t, n) {
      ...
      var a = function (e) {
        ...
        (t.config = e),
          r.default.Config(t),
          r.default.initStyle(t),
          r.default.ActivateCode(t),
          r.default.script(t),
          r.default.i18n(t),
          r.default.smile(t),
          r.default.initLibs(t);
      };
      (a.prototype.initCheck = function () {
            ...
            void 0 !== e.i18n &&
              ...
              "DesertsP" === e.mode
                ? n
                    ...
                    .then(function (t) {
                      var n = t.getEle;
                      (e.ele = n(e)), e.initBody();
                    })
                : "xCss" === e.mode &&
                  (n
                    .e(9)
                    .then(n.t.bind(null, 46, 7))
                    .then(function (e) {
                      (0, e.init)();
                    }),
                  n
                    .e(2)
                    .then(n.t.bind(null, 47, 7))
                    .then(function (t) {
                      var n = t.getEle;
                      (e.ele = n(e)), e.initBody();
                    })));
        ...
        (a.prototype.initBody = function () {
          ...
          e.loading.hide(e.parentCount),
            r.default.alert(e),
            e.loading.show(),
            r.default.initCount(e),
            e.bind();
        }),
        (a.prototype.bind = function () {
          var e = this;
          r.default.inputs(e),
            r.default.previewEvt(e),
            r.default.smileEvt(e),
            "DesertsP" === e.mode && r.default.startEvt(e),
            r.default.getCache(e),
            r.default.resetForm(e),
            r.default.uploadImage(e),
            r.default.cancelReply(e),
            r.default.smileBtnEvt(e),
            r.default.previewBtnEvt(e),
            r.default.atEvt(e),
            r.default.submitBtnEvt(e),
            r.default.insertComment(e, i.default),
            r.default.parentQuery(e),
            r.default.nestQuery(e);
        }),
        (e.exports = a);
    },
    function (e, t, n) {
    ...
    function (e, t, n) {
      ...
      var i = n(1),
        ...
        o = function (e, t) {
          var n = md5(e.get("mail")),
            r = "".concat(i.GBUrl + n, "?size=80&d=robohash");
          if (t.enableQQ && 0 <= e.get("mail").indexOf("@qq.com")) {
            var o = e.get("mail").replace(/@.*/, "");
            null !== o.match(/^\d+$/g) &&
              (r = "https://q1.qlogo.cn/g?b=qq&nk=" + o + "&s=100");
          }
          return r;
        };
      e.exports = function (e, t) {
        ...
        var n = md5(t.get("mail")),
          i = o(t, e);
        if ("DesertsP" === e.mode)
          return (
            '<div class="vcomment-body"><div class="vhead" >' +
            '<img class="vavatar lazyload" data-src="'.concat(i, '"/>') +
            "<a rid='"
              .concat(t.id, "' at='@")
              .concat(t.get("nick"), '\' class="vat" id="at-')
              .concat(t.id, '">')
              .concat(e.i18n.reply, "</a>") +
        ...
        if ("xCss" === e.mode) {
          ...
          if (a) {
            a = uaparser(a);
            var l = "https://cdn.jsdelivr.net/gh/MiniValine/svg@master/";
            try {
              if (a.browser && a.browser.name) {
                c += '<span class="vsys"><i><embed class="msvg" src="' + l;
                var s = a.browser.name.toLowerCase();
                ["samsung browser"].includes(s)
                  ? (c += "mobile-alt")
                  : ["android browser"].includes(s)
                  ? (c += "android")
                  : ["mobile safari", "safari"].includes(s)
                  ? (c += "safari")
                  : ["ie", "iemobile"].includes(s)
                  ? (c += "internet-explorer")
                  : ["wechat"].includes(s)
                  ? (c += "weixin")
                  : ["qqbrowser", "qqbrowserlite", "qq"].includes(s)
                  ? (c += "qq")
                  : ["baiduboxapp", "baidu"].includes(s)
                  ? (c += "paw")
                  : [
                      "chrome",
                      "chromium",
                  ...
                  (c +=
                    ...
                    a.browser.name +
                    " " +
                    (a.browser.version ? a.browser.version : "") +
                    "</span> ");
              } else
                c +=
                  '<span class="vsys"><i><embed class="msvg" src="' +
                  l +
                  'stars.svg"/></i>Magical APP</span>';
              if (a.os && a.os.name) {
                c += '<span class="vsys"><i><embed class="msvg" src="' + l;
                var u = a.os.name.toLowerCase();
                ["mac os", "ios"].includes(u)
                  ? (c += "apple")
                  : ["chromium os"].includes(u)
                  ? (c += "chrome")
                  : ["firefox os"].includes(u)
                  ? (c += "firefox")
                  : ["windows phone", "windows"].includes(u)
                  ? (c += "windows")
                  : [
                      "android",
                      "linux",
                  ...
                  (c +=
                    ...
                    a.os.name +
                    " " +
                    (a.os.version ? a.os.version : "") +
                    "</span>");
              } else
                c +=
                  '<span class="vsys"><i><embed class="msvg" src="' +
                  l +
                  'magic.svg"/></i>Magical OS</span>';
            } catch (e) {
              console.log(e);
            }
            if(e.config.region){
              try {
                var d = window.MV.region.data.country;
                  d &&
                    (c +=
                      '<span class="vsys"><i><embed class="msvg" src="' +
                      l +
          ...
          var d = e.master.includes(md5(t.get("mail").toLowerCase())),
            f = e.friends.includes(md5(t.get("mail").toLowerCase())),
            v = d
              ? '<span class="vtag vmaster">' + e.tagMeta[0] + "</span>"
              : f
              ? '<span class="vtag vfriend">' + e.tagMeta[1] + "</span>"
              : '<span class="vtag vvisitor">' + e.tagMeta[2] + "</span>";
          return (
            (v = e.tagMeta.length ? v : ""),
            '<div class="vcomment-body"><div class="vhead" >' +
              '<img class="vavatar lazyload" data-src="'.concat(i, '"/>') +
              "<a rid='"
                .concat(t.id, "' at='@")
              ...
              '<div class="vmeta-info">'.concat(
                t.get("link")
                  ? '<a class="vname" href="'
                      ...
                      .concat(t.get("nick"), "</a>")
                      .concat(v, '<span class="vsysinfo">')
                      .concat(c, "</span>")
                  : '<span class="vname">'
                      .concat(t.get("nick"), "</span> ")
                      .concat(v, " ")
                      .concat(c)
              ) +
              '<br/><span class="vtime">'.concat(
                (0, r.default)(t.get("createdAt"), e.i18n),
                "</span>"
              ) +
              "</div></div>" +
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        ...
        var r = e.el.querySelector(".vsubmitting");
        (r.innerHTML = n),
          (e.submitting = {
            show: function () {
            ...
            hide: function () {
              r.setAttribute("style", "display:none;"), e.nodata.hide();
            },
          });
      };
    },
    function (e, t, n) {
      ...
      e.exports = function (e) {
        var t = setInterval(function () {
          if (void 0 !== e.emoticonList) {
            clearInterval(t);
            for (
              var n = e.el.querySelector(".vsmile-icons ul"),
                i = e.el.querySelector(".vsmile-bar ul"),
                r = e.emoticonList || [],
                o = 0;
              o < r.length;
              o++
              ...
              for (
                ...
                s.setAttribute("data-src", "".concat(r[o][l])),
                  ...
                  0 === l &&
                    ...
                    s.removeAttribute("class", "lazyload"),
                    c.appendChild(s));
              }
              n.appendChild(a), i.appendChild(c);
            }
            try {
              e.el.querySelector(
                ".vsmile-icons > ul > li:nth-child(1)"
              ).style.display = "block";
              for (
                var u = document.querySelectorAll(".vsmile-bar > ul > li"),
                  d = document.querySelectorAll(".vsmile-icons > ul > li"),
                  f = 0;
                f < u.length;
                f++
              )
                (u[f].index = f),
                  (u[f].onclick = function () {
                    for (var e = 0; e < u.length; e++)
                      (u[e].className = ""), (d[e].style.display = "none");
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        var t =
          ...
          Object.prototype.toString.call(e.config.el)
            ? e.config.el
            : document.querySelectorAll(e.config.el)[0];
        "[object HTMLDivElement]" === Object.prototype.toString.call(t) &&
          ((e.el = t),
          e.el.classList.add("MiniValine"),
          e.el.classList.add("markdown-body"),
    ...
    function (e, t, n) {
      ...
      e.exports = {
        ...
        startEvt: m.default,
        resetForm: g.default,
        cancelReply: h.default,
        smileBtnEvt: y.default,
        previewBtnEvt: b.default,
        inputs: w.default,
        atEvt: x.default,
        submitBtnEvt: C.default,
        insertComment: M.default,
        nestQuery: _.default,
        parentQuery: S.default,
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        (e.emoticonUrl = e.config.emoticonUrl || i.EUrl),
          (e.lang =
            e.config.lang || navigator.language || navigator.userLanguage),
          (e.maxNestLevel = e.config.maxNest || i.MaxNL),
          (e.pageSize = e.config.pageSize || i.PS),
          (e.adminEmailMd5 = e.config.adminEmailMd5 || ""),
          (e.math = e.config.math),
          (e.md = e.config.md),
          (e.visitor = e.config.visitor),
          (e.enableQQ = e.config.enableQQ),
          (e.tagMeta = e.config.tagMeta || []),
          (e.master = e.config.master || []),
          (e.friends = e.config.friends || []),
          (e.mode = e.config.mode || "DesertsP"),
          (e.placeholder = e.config.placeholder || ""),
          (e.C = i.C),
          (e.C.url = e.config.pathname || location.pathname.replace(/\/$/, ""));
      };
    },
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        ...
        (t = e.config.serverURLs || n),
          void 0 === window.disableAVInit &&
            (AV.init({
              appId: e.config.appId,
              appKey: e.config.appKey,
              serverURLs: t,
            }),
            (window.disableAVInit = !0)),
          (e.v = AV);
      };
    },
    function (module, exports, __webpack_require__) {
      ...
      var smile = function (e) {
          if (window.MV.emoticonList)
            ...
            for (var t = 0; t < e.emoticonUrl.length; t++)
              getSmile(e, e.emoticonUrl[t]);
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        e.config.NoRecordIP ||
          (window.MV.ip ? (e.C.ip = window.MV.ip) : (0, o.default)(e)),
          window.MV.pf || ((0, r.default)(i.pf), (window.MV.pf = !0));
      };
    },
    function (module, exports, __webpack_require__) {
      "use strict";
      ...
      e.exports = function (e) {
        var t = setInterval(function () {
          "undefined" != typeof Promise &&
            (clearInterval(t),
            "DesertsP" === e.mode
              ? n.e(7).then(n.t.bind(null, 48, 7))
              : "xCss" === e.mode && n.e(8).then(n.t.bind(null, 49, 7)));
        }, 5);
      };
    },
    function (e, t, n) {
      ...
      e.exports = function (e) {
        var t = setInterval(function () {
          "undefined" != typeof Promise &&
            (clearInterval(t),
            Promise.all([n.e(10), n.e(3)])
              .then(n.t.bind(null, 50, 7))
              .then(function (t) {
                (0, t.lib)(), e.initCheck();
              }));
        }, 5);
      ...
      e.exports = function (e) {
        ...
        i.default.on("keydown", document, function (n) {
          ...
          (n.ctrlKey || n.metaKey) && 13 === i && e.submitEvt(),
            9 !== i ||
              ("veditor" == (document.activeElement.className || "") &&
                (n.preventDefault(), (0, r.default)(t, "    ")));
        });
        var n = function (n) {
          if (n.length)
            for (
        ...
        var o = function (e, t) {
            ...
            (i.onreadystatechange = function () {
              ...
              i.open("POST", "https://imgkr.com/api/files/upload", !0),
              i.send(n);
          },
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        ...
        e.alert = {
          show: function (n) {
            t.innerHTML =
              '<div class="valert txt-center"><div class="vtext">'.concat(
                n.text,
                '</div><div class="vbtns"></div></div>'
              );
            var r = t.querySelector(".vbtns"),
              o = '<button class="vcancel vbtn">'.concat(
                n.ctxt || e.i18n.cancel,
                "</button>"
              ),
              a = '<button class="vsure vbtn">'.concat(
                n.otxt || e.i18n.continue,
                "</button>"
              );
            if (
              ((r.innerHTML = "".concat(o).concat(n.type && a)),
              t
                .querySelector(".vcancel")
              ...
              i.default.on("click", c, function (t) {
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        ...
        var i = AV.Query.or(t, n);
        i.notEqualTo("isSpam", !0),
          i
            .count()
            .then(function (t) {
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        ...
        i.default.on("click", t, function (t) {
          ...
          if (void 0 !== i) {
            var o = "!(:".concat(
              decodeURI(i).replace(/^.*\/(.*)$/, "$1"),
              ":)"
            );
            (0, r.default)(n, o), (e.C.comment = n.value);
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        ...
        i.default.on("click", t, function (n) {
          t.setAttribute("style", "display:none"),
            e.el.querySelector(".auth-section").removeAttribute("style"),
            e.el.querySelector(".veditor").focus();
        });
      };
    },
    function (e, t, n) {
      ...
      e.exports = function (e) {
        ...
        e.reset = function () {
          for (var r in e.mapping)
            if (e.mapping.hasOwnProperty(r)) {
              var o = e.mapping[r];
              (e.el.querySelector(".".concat(r)).value = ""), (e.C[o] = "");
            }
          (e.C.rid = ""),
            (e.C.nick = ""),
            (e.C.at = ""),
            ((e.el.querySelector(".vinputs-area  textarea").placeholder = ""),
            i.default)(e),
            e.previewEvt(e),
            t.getAttribute("triggered") &&
              (t.setAttribute("style", "display:none;"),
              t.removeAttribute("triggered")),
            n.getAttribute("triggered") &&
            ...
            e.el
              ...
              .appendChild(e.el.querySelector(".vinputs-wrap"));
        };
      };
    },
    function (e, t, n) {
      ...
      e.exports = function (e) {
        i.default.on(
          "click",
          e.el.querySelector(".cancel-reply-btn"),
          function (t) {
            e.reset();
          }
        );
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        var t = e.el.querySelector(".vemoji-btn"),
          ...
          r = e.el.querySelector(".vpreview-text"),
          o = e.el.querySelector(".vsmile-body");
        i.default.on("click", t, function (e) {
          r.getAttribute("triggered") &&
            (r.setAttribute("style", "display:none;"),
            r.removeAttribute("triggered"),
            n.classList.remove("actived")),
            o.getAttribute("triggered")
              ? (o.setAttribute("style", "display:none;"),
                o.removeAttribute("triggered"),
                t.classList.remove("actived"))
              : (o.removeAttribute("style"),
                o.setAttribute("triggered", 1),
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        var t = e.el.querySelector(".vpreview-btn"),
          ...
          r = e.el.querySelector(".vpreview-text"),
          o = e.el.querySelector(".vsmile-icons");
        i.default.on("click", t, function (i) {
          if (
            (o.getAttribute("triggered") &&
              (o.setAttribute("style", "display:none;"),
              o.removeAttribute("triggered"),
            ...
            if ((t.classList.add("actived"), "" === e.C.comment))
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        ...
        e.mapping))
          e.mapping.hasOwnProperty(t) &&
            (function () {
              var n = e.mapping[t],
                r = e.el.querySelector(".".concat(t));
              (e.inputs[n] = r),
                i.default.on("input", r, function (t) {
                  (e.C[n] = r.value), e.previewEvt(e);
                });
            })();
      };
    },
      ...
      e.exports = function (e) {
        e.AtEvt = function (t) {
          var n = t.getAttribute("id"),
            r = t.querySelector("#at-".concat(n));
          i.default.on("click", r, function (i) {
            var o = r.getAttribute("at"),
              a = r.getAttribute("rid");
            (e.C.rid = a),
              (e.C.at = o),
              (e.el.querySelector(".vinputs-area  textarea").placeholder = o),
              (e.inputs.comment.value = "".concat(e.inputs.comment.value)),
              t
                .querySelector("#comment-".concat(n))
                .appendChild(e.el.querySelector(".vinputs-wrap")),
              e.el
                .querySelector(".vcancel-comment-reply")
      ...
      e.exports = function (e) {
        ...
        e.submitEvt = function (i) {
          if (t.getAttribute("disabled"))
            ...
            if ("" !== e.C.nick) {
              (0, r.default)(e, e, function (e) {
                if (((e.C.comment = e.TEXT), "" !== e.C.at)) {
                  var t = '<a class="at" href=\'#'
                    .concat(e.C.rid, "'>")
                    .concat(e.C.at, "</a>");
                  e.C.comment = t + " , " + e.C.comment;
                }
                var i = o.default.mail(e.C.mail),
                  r = o.default.link(e.C.link);
                (e.C.mail = i.k ? i.v : ""),
                  (e.C.link = r.k ? r.v : ""),
                  i.k && r.k
                    ? n()
          ...
          try {
            ...
            (o &&
              (/^((25[0-5]|2[0-4]\d|[01]?\d\d?)\.){3}(25[0-5]|2[0-4]\d|[01]?\d\d?)$/.test(
                ...
                /^([\da-fA-F]{1,4}:){7}[\da-fA-F]{1,4}$/.test(o)) &&
              "127.0.0.1" != o) ||
              ((window.MV.fuck = 0), kill());
          } catch (e) {}
          n.setACL(
            (function () {
              var t = new e.v.ACL();
            ...
            n
              ...
              .then(function (n) {
                ...
                if (((i.innerText = Number(i.innerText) + 1), "" === e.C.rid))
                  e.insertComment(n, null, !0);
                else {
                  var r = e.el.querySelector("#children-list-".concat(e.C.rid));
                  e.insertComment(n, r, !0);
                }
    ...
    function (e, t, n) {
      ...
      e.exports = function (e, t, r) {
        e.md || void 0 === e.config.md
          ? Promise.all([n.e(11), n.e(5)])
              .then(n.t.bind(null, 51, 7))
              .then(function (e) {
                var n = e.markdown;
                (t.TEXT = n(t.TEXT)), (0, i.default)(t, r);
              })
          : (0, i.default)(t, r);
      };
    },
    function (e, t, n) {
      ...
      e.exports = {
        mail: function (e) {
          return {
            k: /^[A-Za-z0-9\u4e00-\u9fa5]+@[a-zA-Z0-9_-]+(\.[a-zA-Z0-9_-]+)+$/.test(
              e
            ),
            v: e,
          };
        ...
        link: function (e) {
          return (
            0 < e.length &&
              (e = /^(http|https)/.test(e) ? e : "http://".concat(e)),
            {
              k:
                !(0 < e.length) ||
      ...
      e.exports = function (e, t) {
        e.insertComment = function (i) {
          ...
          a.setAttribute("class", "vcard"),
            ...
            (a.innerHTML = t.vcard(e, i)),
            e.ActivateCode(e);
          for (
            var c = r || e.el.querySelector(".vlist"),
              l = c.querySelectorAll("li"),
            ...
            var f = s[u];
            f &&
              "at" !== f.getAttribute("class") &&
              (f.setAttribute("target", "_blank"),
              f.setAttribute("rel", "nofollow"));
          }
          o ? c.insertBefore(a, l[0]) : c.appendChild(a);
        ...
        var n = function (e) {
          180 < e.offsetHeight &&
            ...
            i.default.on("click", e, function (t) {
        ...
        e.nestQuery = function (t) {
          var n =
              1 < arguments.length && void 0 !== arguments[1]
                ? arguments[1]
                : 1,
            o = t.querySelector(".vcomment-children"),
            a = o.querySelector(".vlist"),
            c = t.getAttribute("id");
          n <= 0 && o.setAttribute("style", "margin-left: 0 !important"),
            n >= e.maxNestLevel
              ? e.v.Query.doCloudQuery(
                  "select count(*) from Comment where rid='"
                    .concat(c, "' and (url='")
                    .concat(
                      e.C.url,
                      "' or url='",
                  ...
                  function (n) {
                    if (0 < n.count) {
                      var r = o.querySelector(".vshow-children-wrapper");
                      r.setAttribute("style", "display: block !important;"),
                        (r.innerHTML = '<span class="vshow-children" rid="'
                          .concat(c, '">')
                          .concat(e.i18n.more, "</span>"));
                      var a = r.querySelector(".vshow-children");
                      i.default.on("click", a, function (n) {
              ...
              : setTimeout(function () {
                  e.v.Query.doCloudQuery(
                    "select nick, comment, link, rid, isSpam, mail, ua from Comment where rid='"
                      .concat(c, "' and (url='")
                      .concat(
                        e.C.url,
                        "' or url='",
                    ...
                    .then(function (t) {
                      var i = (t = (t && t.results) || []).length;
                      if (i)
                        for (
                          var o = function (i) {
                              if (!t[i].get("isSpam")) {
                                (t[i].TEXT = t[i].get("comment")),
                                  (0, r.default)(t[i], function (r) {
                                    t[i].set("comment", r.TEXT);
                                    var o = e.insertComment(t[i], a, !0);
                                    e.nestQuery(o, n + 1);
                                  });
                              }
                            },
      ...
      e.exports = function (e) {
        ...
        (e.parentCount = 0),
          (e.parentQuery = function () {
            ...
            e.loading.show(),
              e.v.Query.doCloudQuery(
                "select nick, comment, link, rid, isSpam, mail, ua from Comment where (rid='' or rid is not exists) and (url='"
                  .concat(
                    e.C.url,
                    "' or url='",
                    "".concat(e.C.url, "/"),
                ...
                .then(function (o) {
                  var a = (o = (o && o.results) || []).length;
                  if (a) {
                    for (
                      var c = function (t) {
                          if (o[t].get("isSpam")) return "continue";
                          (o[t].TEXT = o[t].get("comment")),
                            (0, r.default)(o[t], function (n) {
                              o[t].set("comment", n.TEXT);
                              var i = e.insertComment(
                                o[t],
                                e.el.querySelector(".vlist"),
                                !1
                              );
                              i.setAttribute("style", "margin-bottom: .5em"),
                                e.nestQuery(i);
                            });
                        },
                        l = 0;
                    ...
                    s.innerHTML =
                      e.pageSize * n < e.parentCount
                        ? '<div id="vmore" class="more">'.concat(
                            e.i18n.more,
                            "</div>"
                          )
                        : "";
                    ...
                    u &&
                      i.default.on("click", u, function (n) {
                ...
                .catch(function (t) {
                  console.log(t), e.loading.hide(e.parentCount);
                });
          }),
          e.v.Query.doCloudQuery(
            "select count(*) from Comment where (rid='' or rid is not exists) and (url='".concat(
              e.C.url,
              "' or url='",
              "".concat(e.C.url, "/"),
              "') order by -createdAt"
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        e.ActivateCode = function (e) {
          setTimeout(function () {
            document.getElementsByTagName("pre").length &&
              n.e(6).then(n.t.bind(null, 53, 7));
          }, 500),
            0 != e.math &&
              n
                .e(4)
      ...
      e.exports = function (e) {
        e.previewEvt = function (e) {
          var t =
            ...
            n = e.el.querySelector(".vpreview-btn"),
            r = e.el.querySelector(".vpreview-text"),
            o = e.el.querySelector(".veditor"),
            a = function (i) {
              (i.innerHTML = i.TEXT),
                i.removeAttribute("style"),
                i.setAttribute("triggered", 1),
                n.classList.add("actived"),
                o.value ? autosize(o) : autosize.destroy(o),
                e.ActivateCode(e, t);
            };
          (0, i.default)(e, r, a);
        };
    ...
    function (e, t, n) {
      "use strict";
      e.exports = function (e) {
        (void 0 !== e.visitor && !e.visitor) ||
          n
            .e(13)
            .then(n.t.bind(null, 55, 7))
            .then(function (t) {
              (0, t.MCo)(e.config);
            });
      };
